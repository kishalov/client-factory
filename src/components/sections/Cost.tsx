	...
	return (
		<section id="cost" className="relative container mt-20 lg:mt-40">
			...
			<div className="flex flex-col lg:flex-row lg:items-end">
                ...
                {/* Advertising */}
                <div className="relative bg-[#825BDA] p-5 lg:p-10 rounded-[20px] w-full lg:rounded-t-[40px] lg:rounded-b-none mb-5 lg:mb-0 text-white overflow-hidden">
                    <h3 className="smallheading mb-6 w-[60%]">Advertising cost per client request</h3>
                ...
                {/* Delivery */}
                <div className="relative bg-[#45344C] flex flex-col justify-between w-full p-5 lg:p-10 rounded-[20px] lg:rounded-t-[40px] lg:rounded-b-none mb-5 lg:mb-0 text-white overflow-hidden">
