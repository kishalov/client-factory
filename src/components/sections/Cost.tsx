	...
	return (
		<section id="cost" className="relative container mt-20 lg:mt-40">
			...
			<div className="flex flex-col lg:flex-row lg:items-end">
                {/* Qualification */}
                    <div className="bg-[#C0A5F2] flex-col p-5 lg:p-10 rounded-[20px] lg:rounded-t-[40px] mb-5 lg:mb-0 text-black">
                ...
                {/* Advertising */}
                <div className="relative bg-[#825BDA] p-5 lg:p-10 rounded-[20px] lg:rounded-t-[40px] mb-5 lg:mb-0 text-white overflow-hidden">
                ...
                {/* Delivery */}
                <div className="relative bg-[#45344C] flex flex-col justify-between p-5 lg:p-10 rounded-[20px] lg:rounded-t-[40px] mb-5 lg:mb-0 text-white overflow-hidden">
